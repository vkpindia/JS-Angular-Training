...
let employee = 'John';// js

var employeeName: string = 'John';//ts
...
let employeesName: string = 'John Smith'
var employeeDep: string = "Finance"
...
//pre es-6
var empDesc: string = employeesName + 'work in the' +  employeeDep;
console.log('empDesc', empDesc);
//post es-6
let empdesc: string = `${employeesName} work in the ${employeeDep}`;
console.log('empdesc', empdesc);
...
let thirst: number = 0o377; //octol
let forth: number = 0b11110010011; //binary 
...
let fruits: string[] = ['Apples', 'Orange'];
var fruiutList: Array<string> = ['Apples', 'Orange'];
var fruiutList: Array<string> = new Array('Apples', 'Orange');
let ids: Array<number> = [1024, 1026, 1028];
...
var employeeData: [number, string] = [10, 'Smith'];
...
let str: any = 'Hellow World';
str= 10;
str=true;
str=[];

let arr: any[] = [];
let arrs: Array<any> = [10, 40];
